...
BEGIN
  ...
  FOR v_ind IN SELECT * FROM jsonb_array_elements(p_indications) LOOP
    ...
    ELSE
      ...
      END IF;
      -- Telefone só é obrigatório quando NÃO é um professor selecionado da lista interna da escola.
      -- Para professores do cadastro interno, o telefone pode estar ausente e isso não bloqueia o envio.
