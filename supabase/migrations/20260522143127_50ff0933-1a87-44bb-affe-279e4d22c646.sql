-- Ajusta retorno para refletir totais (turmas e horários usados pela grade), não apenas os recém-criados
...
BEGIN
  ...
  -- Totais agregados (turmas e horários efetivamente utilizados pela grade)
