...
BEGIN
  ...
  -- PLANNING: target ANUAL fixo = max(1, round(CH_anual_total / 3)).
  -- CH_anual_total é calculada SEMPRE a partir das indicações APROVADAS do link
  -- (1º + 2º + anual), espelhando o valor exibido na tela de conferência.
  -- Assim o PL não muda entre escopos FIRST/SECOND/ALL e nunca duplica.
  FOR prof IN
    ...
    FROM (
      ...
      CROSS JOIN LATERAL (
        -- dedup global por (turma, subject) — soma CH UMA vez por par
