-- Atualiza materialize_grade_from_indications para gravar class_mode (PRESENCIAL/ANP)
-- com base em candidato_grade->>'is_anp' ou candidato_grade->>'class_mode'.
...
BEGIN
  ...
  LOOP
    ...
    -- Modo da aula: ANP vs PRESENCIAL
    v_class_mode := CASE
