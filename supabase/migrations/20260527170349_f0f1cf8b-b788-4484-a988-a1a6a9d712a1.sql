...
BEGIN
  ...
  LOOP
    ...
    -- Disciplinas EXATAMENTE conforme indicação do diretor.
    -- Não há mais expansão automática para a "disciplina-irmã" do outro semestre:
    -- o diretor é a fonte da verdade. O filtro de bimestres
    -- (hr_link_subject_bimester_filter) controla em quais bimestres cada
    -- disciplina vai gerar ocorrências/lançamentos.
