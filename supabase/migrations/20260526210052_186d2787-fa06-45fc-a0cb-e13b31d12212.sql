...
BEGIN
  ...
  FOR prof IN
   ...
   LOOP
    ...
    -- PL é hora INDIVIDUAL do professor: o slot precisa estar livre apenas
    -- para o PRÓPRIO professor (independente de outros docentes estarem em
    -- aula no mesmo horário). A preferência continua sendo o turno
    -- predominante, mas caímos em qualquer slot ACTIVE da escola quando o
    -- turno predominante estiver cheio para o professor.
    FOR free_slot IN
      WITH shift_times AS (
